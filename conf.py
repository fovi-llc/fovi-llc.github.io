...
BLOG_AUTHOR = "Jim White"  # (translatable)
BLOG_TITLE = "wiki3.ai"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://wiki3.ai/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://wiki3.ai/"
BLOG_EMAIL = "jim@fovi.com"
BLOG_DESCRIPTION = "Collecting thoughts about AI, software development, and web3 here."  # (translatable)
